...
namespace KDebugUtility
{
	...
	{
		KDebugUtilityInfo ret;
		KDebugUtilityBuilder::PouplateData(info, ret.positions, ret.indices, ret.primtive);
		return ret;
	}
