...
#define VOLUMETRIC_FOG_BINDING_VOXEL_PREV BINDING_TEXTURE0
#define VOLUMETRIC_FOG_BINDING_VOXEL_CURR BINDING_TEXTURE1
#define VOLUMETRIC_FOG_BINDING_VOXEL_RESULT BINDING_TEXTURE2
#define VOLUMETRIC_FOG_BINDING_GBUFFER_RT0 BINDING_TEXTURE3

#define VOLUMETRIC_FOG_BINDING_STATIC_CSM0 BINDING_TEXTURE4
#define VOLUMETRIC_FOG_BINDING_STATIC_CSM1 BINDING_TEXTURE5
#define VOLUMETRIC_FOG_BINDING_STATIC_CSM2 BINDING_TEXTURE6
#define VOLUMETRIC_FOG_BINDING_STATIC_CSM3 BINDING_TEXTURE7

#define VOLUMETRIC_FOG_BINDING_DYNAMIC_CSM0 BINDING_TEXTURE8
#define VOLUMETRIC_FOG_BINDING_DYNAMIC_CSM1 BINDING_TEXTURE9
#define VOLUMETRIC_FOG_BINDING_DYNAMIC_CSM2 BINDING_TEXTURE10
#define VOLUMETRIC_FOG_BINDING_DYNAMIC_CSM3 BINDING_TEXTURE11
