...
#define GROUP_SIZE 8
#define VOLUMETRIC_FOG_BINDING_VOXEL_PREV BINDING_MATERIAL0
#define VOLUMETRIC_FOG_BINDING_VOXEL_CURR BINDING_MATERIAL1
#define VOLUMETRIC_FOG_BINDING_VOXEL_RESULT BINDING_MATERIAL2
#define VOLUMETRIC_FOG_BINDING_GBUFFER_RT0 BINDING_MATERIAL3
