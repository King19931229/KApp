...
#define VOXEL_BINDING_ALBEDO BINDING_TEXTURE0
#define VOXEL_BINDING_NORMAL BINDING_TEXTURE1
#define VOXEL_BINDING_EMISSION BINDING_TEXTURE2

#define VOXEL_BINDING_COUNTER BINDING_TEXTURE0
#define VOXEL_BINDING_FRAGMENTLIST BINDING_TEXTURE1
#define VOXEL_BINDING_COUNTONLY BINDING_TEXTURE2

#define VOXEL_BINDING_STATIC_FLAG BINDING_TEXTURE3
#define VOXEL_BINDING_DIFFUSE_MAP BINDING_TEXTURE4
#define VOXEL_BINDING_OPACITY_MAP BINDING_TEXTURE5
#define VOXEL_BINDING_EMISSION_MAP BINDING_TEXTURE6
#define VOXEL_BINDING_RADIANCE BINDING_TEXTURE7
#define VOXEL_BINDING_TEXMIPMAP_IN BINDING_TEXTURE8
#define VOXEL_BINDING_TEXMIPMAP_OUT BINDING_TEXTURE9

#define VOXEL_VOLUMETRIC_FOG_BINDING_GBUFFER_RT0 BINDING_TEXTURE10
#define VOXEL_BINDING_GBUFFER_RT1 BINDING_TEXTURE11
#define VOXEL_BINDING_GBUFFER_RT2 BINDING_TEXTURE12
#define VOXEL_BINDING_GBUFFER_RT3 BINDING_TEXTURE13

#define VOXEL_BINDING_OCTREE BINDING_TEXTURE14
#define VOXEL_BINDING_OCTREE_DATA BINDING_TEXTURE15
#define VOXEL_BINDING_OCTREE_MIPMAP_DATA BINDING_TEXTURE16
