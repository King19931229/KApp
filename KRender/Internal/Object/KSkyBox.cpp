...
void KSkyBox::LoadResource(const char* cubeTexPath)
{
	...
	ASSERT_RESULT(KRenderGlobal::ShaderManager.Acquire("cube.vert", m_VertexShader, false));
	ASSERT_RESULT(KRenderGlobal::ShaderManager.Acquire("cube.frag", m_FragmentShader, false));
