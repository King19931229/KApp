...
protected:
	...
	{
		GROUP_SIZE = 8,
		BINDING_VOXEL_PREV = SHADER_BINDING_TEXTURE0,
		BINDING_VOXEL_CURR = SHADER_BINDING_TEXTURE1,
		BINDING_VOXEL_RESULT = SHADER_BINDING_TEXTURE2,
		BINDING_GBUFFER_RT0 = SHADER_BINDING_TEXTURE3
	};
