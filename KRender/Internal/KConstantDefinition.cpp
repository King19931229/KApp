	...
	void SafeInit()
	{
		...
		if(!CONSTANT_DETAIL_INIT)
		{
			...
			// DYNAMIC_CASCADED_SHADOW_DETAILS
			{
				...
				// FRUSTUM
				{
					ConstantSemanticDetail DETAIL = { CS_CASCADED_SHADOW_FRUSTUM, EF_R32G32B32A32_FLOAT, 1, MEMBER_SIZE(CASCADED_SHADOW, FRUSTUM), MEMBER_OFFSET(CASCADED_SHADOW, FRUSTUM) };
					DYNAMIC_CASCADED_SHADOW_DETAILS.semanticDetails.push_back(DETAIL);
				}
				// FRUSTUM_PLANES
				{
			...
			// GLOBAL
			{
				// SUN_LIGHT_DIR
				{
					ConstantSemanticDetail DETAIL = { CS_GLOBAL_SUN_LIGHT_DIRECTION, EF_R32G32B32A32_FLOAT, 1, MEMBER_SIZE(GLOBAL, SUN_LIGHT_DIR), MEMBER_OFFSET(GLOBAL, SUN_LIGHT_DIR) };
