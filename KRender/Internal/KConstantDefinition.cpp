	...
	void SafeInit()
	{
		...
		if(!CONSTANT_DETAIL_INIT)
		{
			...
			// CASCADED_SHADOW_DETAILS
			{
				// LIGHT_VIEW_PROJ
				{
					ConstantSemanticDetail DETAIL = { CS_CASCADED_SHADOW_VIEW_PROJ, EF_R32G32B32A32_FLOAT, 4, MEMBER_SIZE(CASCADED_SHADOW, LIGHT_VIEW_PROJ), MEMBER_OFFSET(CASCADED_SHADOW, LIGHT_VIEW_PROJ) };
