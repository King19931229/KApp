	...
	void SafeInit()
	{
		...
		if(!CONSTANT_DETAIL_INIT)
		{
			...
			// VIRTUAL_TEXTURE
			{
				...
				// DESCRIPTION2
				{
					ConstantSemanticDetail DETAIL = { CS_VIRTUAL_TEXTURE_DESCRIPTION2, EF_R32G32B32A32_FLOAT, 1, MEMBER_SIZE(VIRTUAL_TEXTURE, DESCRIPTION2), MEMBER_OFFSET(VIRTUAL_TEXTURE, DESCRIPTION2) };
					VIRTUAL_TEXTUTRE_DETAILS.semanticDetails.push_back(DETAIL);
				}
