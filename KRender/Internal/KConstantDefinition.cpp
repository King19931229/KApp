	...
	void SafeInit()
	{
		...
		if(!CONSTANT_DETAIL_INIT)
		{
			...
			// VOXEL_CLIPMAP_DETAILS
			{
				...
				// UPDATE_REGION_MIN
				{
					ConstantSemanticDetail DETAIL = { CS_VOXEL_CLIPMAP_UPDATE_REGION_MIN, EF_R32G32B32A32_INT, 3 * 6, MEMBER_SIZE(VOXEL_CLIPMAP, UPDATE_REGION_MIN), MEMBER_OFFSET(VOXEL_CLIPMAP, UPDATE_REGION_MIN) };
					VOXEL_CLIPMAP_DETAILS.semanticDetails.push_back(DETAIL);
				}
				// UPDATE_REGION_MAX
				{
					ConstantSemanticDetail DETAIL = { CS_VOXEL_CLIPMAP_UPDATE_REGION_MAX, EF_R32G32B32A32_INT, 3 * 6, MEMBER_SIZE(VOXEL_CLIPMAP, UPDATE_REGION_MAX), MEMBER_OFFSET(VOXEL_CLIPMAP, UPDATE_REGION_MAX) };
					VOXEL_CLIPMAP_DETAILS.semanticDetails.push_back(DETAIL);
				}
