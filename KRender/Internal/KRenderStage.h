...
enum RenderStage
{
	...
	RENDER_STAGE_TRANSPRANT_BEGIN,
	RENDER_STAGE_TRANSPRANT = RENDER_STAGE_TRANSPRANT_BEGIN,

	RENDER_STAGE_TRANSPRANT_DEPTH_PEELING,
	RENDER_STAGE_TRANSPRANT_DEPTH_PEELING_INSTANCE,

	RENDER_STAGE_TRANSPRANT_ABUFFER_DEPTH_PEELING,
	RENDER_STAGE_TRANSPRANT_ABUFFER_DEPTH_PEELING_INSTANCE,

	RENDER_STAGE_TRANSPRANT_END = RENDER_STAGE_TRANSPRANT_ABUFFER_DEPTH_PEELING_INSTANCE,
