...
{
	ASSERT_RESULT(m_VertexShader->InitFromFile(ST_VERTEX, "cameracube.vert", false));
	ASSERT_RESULT(m_FragmentShader->InitFromFile(ST_FRAGMENT, "cameracube.frag", false));
