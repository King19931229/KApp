...
{
	ASSERT_RESULT(m_VertexShader->InitFromFile(ST_VERTEX, "others/cameracube.vert", false));
	ASSERT_RESULT(m_FragmentShader->InitFromFile(ST_FRAGMENT, "others/cameracube.frag", false));
