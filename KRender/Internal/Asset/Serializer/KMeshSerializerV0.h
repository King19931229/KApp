...
protected:
	...
	bool ReadMaterialElementData(IKDataStreamPtr& stream, MaterialInfo& materialData);
	...
	bool WriteMaterialElementData(IKDataStreamPtr& stream, const MaterialInfo& materialData);
