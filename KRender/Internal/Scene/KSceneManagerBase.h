...
public:
	...
	virtual bool GetVisibleEntity(const KCamera* camera, std::deque<IKEntity*>& visibles) = 0;
	virtual bool GetVisibleEntity(const KAABBBox* bound, std::deque<IKEntity*>& visibles) = 0;
	virtual bool GetAllEntity(std::deque<IKEntity*>& visibles) = 0;
	virtual bool GetDebugEntity(std::deque<IKEntity*>& debugVisibles) = 0;
