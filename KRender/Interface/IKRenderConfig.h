...
enum ShaderBinding
{
#define CONSTANT_BUFFER_BINDIN(CONSTANT) SB_##CONSTANT = CBT_##CONSTANT
...
#define RESERVE_BINDING(SLOT) ST_RESERVE##SLOT
	RESERVE_BINDING(0),
	RESERVE_BINDING(1),
#undef RESERVE_BINDING

#define TEXTURE_BINDING(SLOT) SB_TEXTURE##SLOT
	TEXTURE_BINDING(0),
	TEXTURE_BINDING(1),
	TEXTURE_BINDING(2),
	TEXTURE_BINDING(3),
