...
enum ConstantBufferType
{
	...
	CBT_CAMERA,
	CBT_SHADOW,
	CBT_DYNAMIC_CASCADED_SHADOW,
	CBT_STATIC_CASCADED_SHADOW,
	CBT_VOXEL,
	CBT_VOXEL_CLIPMAP,
	CBT_GLOBAL,
	// Dynamic Binding
...
enum
{
	SBT_BEGIN = SBT_POSITION_NORMAL_UV,
	SBT_END = SBT_MESHLET_PRIM,
...
enum ShaderBinding
{
	#define CONSTANT_BUFFER_BINDING(CONSTANT)	SHADER_BINDING_##CONSTANT = CBT_##CONSTANT,
	#define STORAGE_BUFFER_BINDING(STORAGE)		SHADER_BINDING_##STORAGE = SBT_##STORAGE,
	#define TEXTURE_BINDING(SLOT)				SHADER_BINDING_TEXTURE##SLOT = TB_BEGIN + SLOT,
