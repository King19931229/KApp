...
struct IKComputePipeline
{
	...
	virtual void BindStorageImage(uint32_t location, IKFrameBufferPtr target, ComputeImageFlag flag, uint32_t mipmap, bool dynamicWrite) = 0;
	...
	virtual void BindStorageImages(uint32_t location, const std::vector<IKFrameBufferPtr>& targets, ComputeImageFlag flag, uint32_t mipmap, bool dynamicWrite) = 0;
